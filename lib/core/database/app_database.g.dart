...
class $PlayersTable extends Players with TableInfo<$PlayersTable, Player> {
  ...
  static const VerificationMeta _puzzlePiecesMeta = const VerificationMeta(
    'puzzlePieces',
  );
  @override
  late final GeneratedColumn<int> puzzlePieces = GeneratedColumn<int>(
    'puzzle_pieces',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _itemPlusTimeMeta = const VerificationMeta(
    'itemPlusTime',
  );
  @override
  late final GeneratedColumn<int> itemPlusTime = GeneratedColumn<int>(
    'item_plus_time',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _itemMoreNumbersMeta = const VerificationMeta(
    'itemMoreNumbers',
  );
  @override
  late final GeneratedColumn<int> itemMoreNumbers = GeneratedColumn<int>(
    'item_more_numbers',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _itemRevealPathMeta = const VerificationMeta(
    'itemRevealPath',
  );
  @override
  late final GeneratedColumn<int> itemRevealPath = GeneratedColumn<int>(
    'item_reveal_path',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  late final GeneratedColumn<DateTime> lastLifeLostAt =
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('puzzle_pieces')) {
      context.handle(
        _puzzlePiecesMeta,
        puzzlePieces.isAcceptableOrUnknown(
          data['puzzle_pieces']!,
          _puzzlePiecesMeta,
        ),
      );
    }
    if (data.containsKey('item_plus_time')) {
      context.handle(
        _itemPlusTimeMeta,
        itemPlusTime.isAcceptableOrUnknown(
          data['item_plus_time']!,
          _itemPlusTimeMeta,
        ),
      );
    }
    if (data.containsKey('item_more_numbers')) {
      context.handle(
        _itemMoreNumbersMeta,
        itemMoreNumbers.isAcceptableOrUnknown(
          data['item_more_numbers']!,
          _itemMoreNumbersMeta,
        ),
      );
    }
    if (data.containsKey('item_reveal_path')) {
      context.handle(
        _itemRevealPathMeta,
        itemRevealPath.isAcceptableOrUnknown(
          data['item_reveal_path']!,
          _itemRevealPathMeta,
        ),
      );
    }
    if (data.containsKey('last_life_lost_at')) {
      context.handle(
        _lastLifeLostAtMeta,
        lastLifeLostAt.isAcceptableOrUnknown(
          data['last_life_lost_at']!,
          _lastLifeLostAtMeta,
        ),
      );
    }
  ...
  Player map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Player(
      ...
      highscore: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}highscore'],
      )!,
      lives: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}lives'],
      )!,
      puzzlePieces: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}puzzle_pieces'],
      )!,
      itemPlusTime: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}item_plus_time'],
      )!,
      itemMoreNumbers: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}item_more_numbers'],
      )!,
      itemRevealPath: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class Player extends DataClass implements Insertable<Player> {
  ...
  PlayersCompanion toCompanion(bool nullToAbsent) {
    return PlayersCompanion(
      ...
      lives: Value(lives),
      puzzlePieces: Value(puzzlePieces),
  ...
  factory Player.fromJson(
    ...
    return Player(
      ...
      puzzlePieces: serializer.fromJson<int>(json['puzzlePieces']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'puzzlePieces': serializer.toJson<int>(puzzlePieces),
  ...
  Player copyWithCompanion(PlayersCompanion data) {
    return Player(
      ...
      puzzlePieces: data.puzzlePieces.present
          ? data.puzzlePieces.value
          : this.puzzlePieces,
      itemPlusTime: data.itemPlusTime.present
          ? data.itemPlusTime.value
          : this.itemPlusTime,
      itemMoreNumbers: data.itemMoreNumbers.present
          ? data.itemMoreNumbers.value
          : this.itemMoreNumbers,
  ...
  String toString() {
    return (StringBuffer('Player(')
          ...
          ..write('lives: $lives, ')
          ..write('puzzlePieces: $puzzlePieces, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Player &&
          ...
          other.puzzlePieces == this.puzzlePieces &&
...
class PlayersCompanion extends UpdateCompanion<Player> {
  ...
  const PlayersCompanion({
    ...
    this.puzzlePieces = const Value.absent(),
  ...
  static Insertable<Player> custom({
    ...
    return RawValuesInsertable({
      ...
      if (puzzlePieces != null) 'puzzle_pieces': puzzlePieces,
...
class $ProgressionsTable extends Progressions
    with TableInfo<$ProgressionsTable, Progression> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _playerSupabaseIdMeta = const VerificationMeta(
    'playerSupabaseId',
  );
  @override
  late final GeneratedColumn<String> playerSupabaseId = GeneratedColumn<String>(
    'player_supabase_id',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  unlockedWorlds = GeneratedColumn<String>(
    'unlocked_worlds',
    aliasedName,
    false,
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<List<String>>($ProgressionsTable.$converterunlockedWorlds);
  static const VerificationMeta _updatedAtMeta = const VerificationMeta(
    'updatedAt',
  );
  @override
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<Progression> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('player_supabase_id')) {
      context.handle(
        _playerSupabaseIdMeta,
        playerSupabaseId.isAcceptableOrUnknown(
          data['player_supabase_id']!,
          _playerSupabaseIdMeta,
        ),
      );
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Progression map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return Progression(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      playerSupabaseId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}player_supabase_id'],
      ),
      currentLevel: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}current_level'],
      )!,
      unlockedWorlds: $ProgressionsTable.$converterunlockedWorlds.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}unlocked_worlds'],
        )!,
      ),
      updatedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
  ...
  static TypeConverter<List<String>, String> $converterunlockedWorlds =
      const WorldListConverter();
}

class Progression extends DataClass implements Insertable<Progression> {
  final int id;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
    if (!nullToAbsent || playerSupabaseId != null) {
      map['player_supabase_id'] = Variable<String>(playerSupabaseId);
    }
    map['current_level'] = Variable<int>(currentLevel);
    {
      map['unlocked_worlds'] = Variable<String>(
        $ProgressionsTable.$converterunlockedWorlds.toSql(unlockedWorlds),
      );
    }
    if (!nullToAbsent || updatedAt != null) {
      map['updated_at'] = Variable<DateTime>(updatedAt);
  ...
  ProgressionsCompanion toCompanion(bool nullToAbsent) {
    return ProgressionsCompanion(
      id: Value(id),
      playerSupabaseId: playerSupabaseId == null && nullToAbsent
          ? const Value.absent()
          : Value(playerSupabaseId),
      currentLevel: Value(currentLevel),
      unlockedWorlds: Value(unlockedWorlds),
      updatedAt: updatedAt == null && nullToAbsent
          ? const Value.absent()
          : Value(updatedAt),
    );
  ...
  factory Progression.fromJson(
    ...
    return Progression(
      id: serializer.fromJson<int>(json['id']),
      playerSupabaseId: serializer.fromJson<String?>(json['playerSupabaseId']),
      currentLevel: serializer.fromJson<int>(json['currentLevel']),
      unlockedWorlds: serializer.fromJson<List<String>>(json['unlockedWorlds']),
      updatedAt: serializer.fromJson<DateTime?>(json['updatedAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'playerSupabaseId': serializer.toJson<String?>(playerSupabaseId),
      'currentLevel': serializer.toJson<int>(currentLevel),
      'unlockedWorlds': serializer.toJson<List<String>>(unlockedWorlds),
      'updatedAt': serializer.toJson<DateTime?>(updatedAt),
    };
  }
  ...
  Progression copyWith({
    int? id,
    Value<String?> playerSupabaseId = const Value.absent(),
    int? currentLevel,
    List<String>? unlockedWorlds,
    Value<DateTime?> updatedAt = const Value.absent(),
  }) => Progression(
    id: id ?? this.id,
    playerSupabaseId: playerSupabaseId.present
        ? playerSupabaseId.value
        : this.playerSupabaseId,
    currentLevel: currentLevel ?? this.currentLevel,
    unlockedWorlds: unlockedWorlds ?? this.unlockedWorlds,
    updatedAt: updatedAt.present ? updatedAt.value : this.updatedAt,
  );
  Progression copyWithCompanion(ProgressionsCompanion data) {
    return Progression(
      id: data.id.present ? data.id.value : this.id,
      playerSupabaseId: data.playerSupabaseId.present
          ? data.playerSupabaseId.value
          : this.playerSupabaseId,
      currentLevel: data.currentLevel.present
          ? data.currentLevel.value
          : this.currentLevel,
      unlockedWorlds: data.unlockedWorlds.present
          ? data.unlockedWorlds.value
          : this.unlockedWorlds,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('Progression(')
          ..write('id: $id, ')
          ..write('playerSupabaseId: $playerSupabaseId, ')
          ..write('currentLevel: $currentLevel, ')
          ..write('unlockedWorlds: $unlockedWorlds, ')
          ..write('updatedAt: $updatedAt')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is Progression &&
          other.id == this.id &&
          other.playerSupabaseId == this.playerSupabaseId &&
          other.currentLevel == this.currentLevel &&
          other.unlockedWorlds == this.unlockedWorlds &&
          other.updatedAt == this.updatedAt);
}
...
class ProgressionsCompanion extends UpdateCompanion<Progression> {
  ...
  const ProgressionsCompanion({
    this.id = const Value.absent(),
    this.playerSupabaseId = const Value.absent(),
    this.currentLevel = const Value.absent(),
    this.unlockedWorlds = const Value.absent(),
    this.updatedAt = const Value.absent(),
  });
  ...
  static Insertable<Progression> custom({
    Expression<int>? id,
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (playerSupabaseId != null) 'player_supabase_id': playerSupabaseId,
      if (currentLevel != null) 'current_level': currentLevel,
      if (unlockedWorlds != null) 'unlocked_worlds': unlockedWorlds,
      if (updatedAt != null) 'updated_at': updatedAt,
    });
  }
  ...
  ProgressionsCompanion copyWith({
    Value<int>? id,
    Value<String?>? playerSupabaseId,
    Value<int>? currentLevel,
    Value<List<String>>? unlockedWorlds,
    Value<DateTime?>? updatedAt,
  }) {
    return ProgressionsCompanion(
      id: id ?? this.id,
      playerSupabaseId: playerSupabaseId ?? this.playerSupabaseId,
      currentLevel: currentLevel ?? this.currentLevel,
      unlockedWorlds: unlockedWorlds ?? this.unlockedWorlds,
      updatedAt: updatedAt ?? this.updatedAt,
    );
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (unlockedWorlds.present) {
      map['unlocked_worlds'] = Variable<String>(
        $ProgressionsTable.$converterunlockedWorlds.toSql(unlockedWorlds.value),
      );
    }
    if (updatedAt.present) {
      map['updated_at'] = Variable<DateTime>(updatedAt.value);
...
class $LevelCompletionsTable extends LevelCompletions
  ...
  static const VerificationMeta _completionTimeSecondsMeta =
      const VerificationMeta('completionTimeSeconds');
  @override
  late final GeneratedColumn<int> completionTimeSeconds = GeneratedColumn<int>(
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<LevelCompletion> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('completion_time_seconds')) {
      context.handle(
        _completionTimeSecondsMeta,
        completionTimeSeconds.isAcceptableOrUnknown(
  ...
  LevelCompletion map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LevelCompletion(
      ...
      completionTimeSeconds: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}completion_time_seconds'],
      )!,
...
class LevelCompletion extends DataClass implements Insertable<LevelCompletion> {
  ...
  const LevelCompletion({
    required this.id,
    required this.playerSupabaseId,
  ...
  LevelCompletionsCompanion toCompanion(bool nullToAbsent) {
    return LevelCompletionsCompanion(
      ...
      completionTimeSeconds: Value(completionTimeSeconds),
      completedAt: Value(completedAt),
    );
  }

  factory LevelCompletion.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return LevelCompletion(
      ...
      completionTimeSeconds: serializer.fromJson<int>(
        json['completionTimeSeconds'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'completionTimeSeconds': serializer.toJson<int>(completionTimeSeconds),
  ...
  LevelCompletion copyWithCompanion(LevelCompletionsCompanion data) {
    return LevelCompletion(
      ...
      levelNumber: data.levelNumber.present
          ...
          : this.levelNumber,
      completionTimeSeconds: data.completionTimeSeconds.present
          ? data.completionTimeSeconds.value
  ...
  String toString() {
    return (StringBuffer('LevelCompletion(')
          ...
          ..write('completionTimeSeconds: $completionTimeSeconds, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is LevelCompletion &&
          ...
          other.completionTimeSeconds == this.completionTimeSeconds &&
...
class LevelCompletionsCompanion extends UpdateCompanion<LevelCompletion> {
  ...
  const LevelCompletionsCompanion({
    ...
    this.completionTimeSeconds = const Value.absent(),
  ...
  LevelCompletionsCompanion copyWith({
    ...
    Value<int>? completionTimeSeconds,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (completionTimeSeconds.present) {
      map['completion_time_seconds'] = Variable<int>(
        completionTimeSeconds.value,
      );
    }
...
class $GlobalLevelsTable extends GlobalLevels
    with TableInfo<$GlobalLevelsTable, GlobalLevel> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _hintsJsonMeta = const VerificationMeta(
    'hintsJson',
  );
  @override
  late final GeneratedColumn<String> hintsJson = GeneratedColumn<String>(
    'hints_json',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _wallsJsonMeta = const VerificationMeta(
    'wallsJson',
  );
  @override
  late final GeneratedColumn<String> wallsJson = GeneratedColumn<String>(
    'walls_json',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<GlobalLevel> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('hints_json')) {
      context.handle(
        _hintsJsonMeta,
        hintsJson.isAcceptableOrUnknown(data['hints_json']!, _hintsJsonMeta),
      );
    } else if (isInserting) {
    ...
    if (data.containsKey('walls_json')) {
      context.handle(
        _wallsJsonMeta,
        wallsJson.isAcceptableOrUnknown(data['walls_json']!, _wallsJsonMeta),
      );
    } else if (isInserting) {
  ...
  @override
  GlobalLevel map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return GlobalLevel(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      hintsJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}hints_json'],
      )!,
      wallsJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}walls_json'],
      )!,
  ...
  $GlobalLevelsTable createAlias(String alias) {
    return $GlobalLevelsTable(attachedDatabase, alias);
  }
}

class GlobalLevel extends DataClass implements Insertable<GlobalLevel> {
  final int id;
  final String worldId;
  final int levelNumber;
  ...
  const GlobalLevel({
    ...
    required this.worldId,
    required this.levelNumber,
    required this.hintsJson,
    required this.wallsJson,
  ...
  GlobalLevelsCompanion toCompanion(bool nullToAbsent) {
    return GlobalLevelsCompanion(
      id: Value(id),
      worldId: Value(worldId),
      levelNumber: Value(levelNumber),
      hintsJson: Value(hintsJson),
      wallsJson: Value(wallsJson),
      solutionJson: Value(solutionJson),
      createdAt: Value(createdAt),
    );
  }

  factory GlobalLevel.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return GlobalLevel(
      ...
      worldId: serializer.fromJson<String>(json['worldId']),
      levelNumber: serializer.fromJson<int>(json['levelNumber']),
      hintsJson: serializer.fromJson<String>(json['hintsJson']),
      wallsJson: serializer.fromJson<String>(json['wallsJson']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'worldId': serializer.toJson<String>(worldId),
      'levelNumber': serializer.toJson<int>(levelNumber),
      'hintsJson': serializer.toJson<String>(hintsJson),
      'wallsJson': serializer.toJson<String>(wallsJson),
      'solutionJson': serializer.toJson<String>(solutionJson),
      'createdAt': serializer.toJson<DateTime>(createdAt),
    };
  }

  GlobalLevel copyWith({
    int? id,
    String? worldId,
    int? levelNumber,
    String? hintsJson,
    ...
    worldId: worldId ?? this.worldId,
    levelNumber: levelNumber ?? this.levelNumber,
    hintsJson: hintsJson ?? this.hintsJson,
    wallsJson: wallsJson ?? this.wallsJson,
    solutionJson: solutionJson ?? this.solutionJson,
    createdAt: createdAt ?? this.createdAt,
  );
  GlobalLevel copyWithCompanion(GlobalLevelsCompanion data) {
    return GlobalLevel(
      id: data.id.present ? data.id.value : this.id,
      worldId: data.worldId.present ? data.worldId.value : this.worldId,
      levelNumber: data.levelNumber.present
          ? data.levelNumber.value
          : this.levelNumber,
      hintsJson: data.hintsJson.present ? data.hintsJson.value : this.hintsJson,
      wallsJson: data.wallsJson.present ? data.wallsJson.value : this.wallsJson,
  ...
  @override
  String toString() {
    return (StringBuffer('GlobalLevel(')
          ..write('id: $id, ')
          ..write('worldId: $worldId, ')
          ..write('levelNumber: $levelNumber, ')
          ..write('hintsJson: $hintsJson, ')
          ..write('wallsJson: $wallsJson, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is GlobalLevel &&
          other.id == this.id &&
          other.worldId == this.worldId &&
          other.levelNumber == this.levelNumber &&
          other.hintsJson == this.hintsJson &&
          other.wallsJson == this.wallsJson &&
...
class GlobalLevelsCompanion extends UpdateCompanion<GlobalLevel> {
  ...
  const GlobalLevelsCompanion({
    this.id = const Value.absent(),
    this.worldId = const Value.absent(),
    this.levelNumber = const Value.absent(),
    this.hintsJson = const Value.absent(),
    this.wallsJson = const Value.absent(),
    this.solutionJson = const Value.absent(),
    this.createdAt = const Value.absent(),
  });
  GlobalLevelsCompanion.insert({
    this.id = const Value.absent(),
    required String worldId,
    required int levelNumber,
    required String hintsJson,
    required String wallsJson,
    ...
    this.createdAt = const Value.absent(),
       ...
       wallsJson = Value(wallsJson),
       solutionJson = Value(solutionJson);
  static Insertable<GlobalLevel> custom({
    Expression<int>? id,
    Expression<String>? worldId,
    Expression<int>? levelNumber,
    ...
    return RawValuesInsertable({
      ...
      if (worldId != null) 'world_id': worldId,
      if (levelNumber != null) 'level_number': levelNumber,
      if (hintsJson != null) 'hints_json': hintsJson,
      if (wallsJson != null) 'walls_json': wallsJson,
      if (solutionJson != null) 'solution_json': solutionJson,
      if (createdAt != null) 'created_at': createdAt,
    });
  }

  GlobalLevelsCompanion copyWith({
    Value<int>? id,
    Value<String>? worldId,
    Value<int>? levelNumber,
    Value<String>? hintsJson,
    Value<String>? wallsJson,
  ...
  @override
  String toString() {
    return (StringBuffer('GlobalLevelsCompanion(')
          ..write('id: $id, ')
          ..write('worldId: $worldId, ')
          ..write('levelNumber: $levelNumber, ')
          ..write('hintsJson: $hintsJson, ')
...
class $FriendsTable extends Friends with TableInfo<$FriendsTable, Friend> {
  ...
  static const VerificationMeta _friendUsernameMeta = const VerificationMeta(
    'friendUsername',
  );
  @override
  late final GeneratedColumn<String> friendUsername = GeneratedColumn<String>(
    'friend_username',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('friend_username')) {
      context.handle(
        _friendUsernameMeta,
        friendUsername.isAcceptableOrUnknown(
  ...
  Friend map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Friend(
      ...
      friendUsername: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}friend_username'],
      )!,
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
...
class Friend extends DataClass implements Insertable<Friend> {
  ...
  factory Friend.fromJson(
    ...
    return Friend(
      ...
      friendUsername: serializer.fromJson<String>(json['friendUsername']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'friendUsername': serializer.toJson<String>(friendUsername),
      'createdAt': serializer.toJson<DateTime>(createdAt),
    };
  }
  ...
  Friend copyWithCompanion(FriendsCompanion data) {
    return Friend(
      ...
      friendUsername: data.friendUsername.present
          ? data.friendUsername.value
          : this.friendUsername,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
    );
  }
  ...
  String toString() {
    return (StringBuffer('Friend(')
          ...
          ..write('friendUsername: $friendUsername, ')
          ..write('createdAt: $createdAt')
          ..write(')'))
        .toString();
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, playerId, friendId, friendUsername, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Friend &&
          ...
          other.friendUsername == this.friendUsername &&
          other.createdAt == this.createdAt);
}
...
class FriendsCompanion extends UpdateCompanion<Friend> {
  ...
  const FriendsCompanion({
    ...
    this.friendUsername = const Value.absent(),
    this.createdAt = const Value.absent(),
  });
...
class FriendRequest extends DataClass implements Insertable<FriendRequest> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, senderId, receiverId, senderUsername, status, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $DailyChallengesTable extends DailyChallenges
  ...
  static const VerificationMeta _isDailyLevelCompletedMeta =
      const VerificationMeta('isDailyLevelCompleted');
  @override
  late final GeneratedColumn<bool> isDailyLevelCompleted =
      GeneratedColumn<bool>(
        'is_daily_level_completed',
        aliasedName,
        false,
        type: DriftSqlType.bool,
        requiredDuringInsert: false,
        defaultConstraints: GeneratedColumn.constraintIsAlways(
          'CHECK ("is_daily_level_completed" IN (0, 1))',
        ),
        defaultValue: const Constant(false),
      );
  static const VerificationMeta _dailyLevelTimeMeta = const VerificationMeta(
    'dailyLevelTime',
  );
  @override
  late final GeneratedColumn<int> dailyLevelTime = GeneratedColumn<int>(
    'daily_level_time',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  static const VerificationMeta _seriesCurrentLevelMeta =
      const VerificationMeta('seriesCurrentLevel');
  @override
  late final GeneratedColumn<int> seriesCurrentLevel = GeneratedColumn<int>(
    'series_current_level',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
  ...
  static const VerificationMeta _seriesAccumulatedTimeMeta =
      const VerificationMeta('seriesAccumulatedTime');
  @override
  late final GeneratedColumn<int> seriesAccumulatedTime = GeneratedColumn<int>(
    'series_accumulated_time',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
  ...
  static const VerificationMeta _isSeriesCompletedMeta = const VerificationMeta(
    'isSeriesCompleted',
  );
  @override
  late final GeneratedColumn<bool> isSeriesCompleted = GeneratedColumn<bool>(
    'is_series_completed',
    aliasedName,
    false,
    type: DriftSqlType.bool,
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways(
      'CHECK ("is_series_completed" IN (0, 1))',
    ),
    defaultValue: const Constant(false),
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('is_daily_level_completed')) {
      context.handle(
        _isDailyLevelCompletedMeta,
        isDailyLevelCompleted.isAcceptableOrUnknown(
          data['is_daily_level_completed']!,
          _isDailyLevelCompletedMeta,
        ),
      );
    }
    if (data.containsKey('daily_level_time')) {
      context.handle(
        _dailyLevelTimeMeta,
        dailyLevelTime.isAcceptableOrUnknown(
          data['daily_level_time']!,
          _dailyLevelTimeMeta,
        ),
      );
    }
    if (data.containsKey('series_current_level')) {
      context.handle(
        _seriesCurrentLevelMeta,
        seriesCurrentLevel.isAcceptableOrUnknown(
          data['series_current_level']!,
          _seriesCurrentLevelMeta,
        ),
      );
    }
    if (data.containsKey('series_accumulated_time')) {
      context.handle(
        _seriesAccumulatedTimeMeta,
        seriesAccumulatedTime.isAcceptableOrUnknown(
          data['series_accumulated_time']!,
          _seriesAccumulatedTimeMeta,
        ),
      );
    }
    if (data.containsKey('is_series_completed')) {
      context.handle(
        _isSeriesCompletedMeta,
        isSeriesCompleted.isAcceptableOrUnknown(
          data['is_series_completed']!,
          _isSeriesCompletedMeta,
        ),
      );
    }
  ...
  DailyChallenge map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DailyChallenge(
      ...
      isDailyLevelCompleted: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_daily_level_completed'],
      )!,
      dailyLevelTime: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}daily_level_time'],
      )!,
      seriesCurrentLevel: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}series_current_level'],
      )!,
      seriesAccumulatedTime: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}series_accumulated_time'],
      )!,
      isSeriesCompleted: attachedDatabase.typeMapping.read(
        DriftSqlType.bool,
        data['${effectivePrefix}is_series_completed'],
      )!,
    );
  }
...
class DailyChallenge extends DataClass implements Insertable<DailyChallenge> {
  ...
  const DailyChallenge({
    ...
    required this.playerSupabaseId,
    required this.date,
    required this.isDailyLevelCompleted,
    required this.dailyLevelTime,
    required this.seriesCurrentLevel,
    required this.seriesAccumulatedTime,
  ...
  DailyChallengesCompanion toCompanion(bool nullToAbsent) {
    return DailyChallengesCompanion(
      ...
      playerSupabaseId: Value(playerSupabaseId),
      date: Value(date),
      isDailyLevelCompleted: Value(isDailyLevelCompleted),
      dailyLevelTime: Value(dailyLevelTime),
      seriesCurrentLevel: Value(seriesCurrentLevel),
      seriesAccumulatedTime: Value(seriesAccumulatedTime),
      isSeriesCompleted: Value(isSeriesCompleted),
    );
  }
  ...
  factory DailyChallenge.fromJson(
    ...
    return DailyChallenge(
      ...
      isDailyLevelCompleted: serializer.fromJson<bool>(
        json['isDailyLevelCompleted'],
      ),
      dailyLevelTime: serializer.fromJson<int>(json['dailyLevelTime']),
      seriesCurrentLevel: serializer.fromJson<int>(json['seriesCurrentLevel']),
      seriesAccumulatedTime: serializer.fromJson<int>(
        json['seriesAccumulatedTime'],
      ),
      isSeriesCompleted: serializer.fromJson<bool>(json['isSeriesCompleted']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'isDailyLevelCompleted': serializer.toJson<bool>(isDailyLevelCompleted),
      'dailyLevelTime': serializer.toJson<int>(dailyLevelTime),
      'seriesCurrentLevel': serializer.toJson<int>(seriesCurrentLevel),
      'seriesAccumulatedTime': serializer.toJson<int>(seriesAccumulatedTime),
      'isSeriesCompleted': serializer.toJson<bool>(isSeriesCompleted),
    };
  }
  ...
  DailyChallenge copyWith({
    ...
    playerSupabaseId: playerSupabaseId ?? this.playerSupabaseId,
    date: date ?? this.date,
    isDailyLevelCompleted: isDailyLevelCompleted ?? this.isDailyLevelCompleted,
    dailyLevelTime: dailyLevelTime ?? this.dailyLevelTime,
    seriesCurrentLevel: seriesCurrentLevel ?? this.seriesCurrentLevel,
  ...
  DailyChallenge copyWithCompanion(DailyChallengesCompanion data) {
    return DailyChallenge(
      ...
      isDailyLevelCompleted: data.isDailyLevelCompleted.present
          ? data.isDailyLevelCompleted.value
          : this.isDailyLevelCompleted,
      dailyLevelTime: data.dailyLevelTime.present
          ? data.dailyLevelTime.value
          : this.dailyLevelTime,
      seriesCurrentLevel: data.seriesCurrentLevel.present
          ? data.seriesCurrentLevel.value
          : this.seriesCurrentLevel,
      seriesAccumulatedTime: data.seriesAccumulatedTime.present
          ? data.seriesAccumulatedTime.value
          : this.seriesAccumulatedTime,
      isSeriesCompleted: data.isSeriesCompleted.present
          ? data.isSeriesCompleted.value
          : this.isSeriesCompleted,
    );
  }
  ...
  String toString() {
    return (StringBuffer('DailyChallenge(')
          ...
          ..write('playerSupabaseId: $playerSupabaseId, ')
          ..write('date: $date, ')
          ..write('isDailyLevelCompleted: $isDailyLevelCompleted, ')
          ..write('dailyLevelTime: $dailyLevelTime, ')
          ..write('seriesCurrentLevel: $seriesCurrentLevel, ')
          ..write('seriesAccumulatedTime: $seriesAccumulatedTime, ')
          ..write('isSeriesCompleted: $isSeriesCompleted')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is DailyChallenge &&
          ...
          other.isDailyLevelCompleted == this.isDailyLevelCompleted &&
          other.dailyLevelTime == this.dailyLevelTime &&
          other.seriesCurrentLevel == this.seriesCurrentLevel &&
          other.seriesAccumulatedTime == this.seriesAccumulatedTime &&
          other.isSeriesCompleted == this.isSeriesCompleted);
}
...
class DailyChallengesCompanion extends UpdateCompanion<DailyChallenge> {
  ...
  const DailyChallengesCompanion({
    ...
    this.isDailyLevelCompleted = const Value.absent(),
    this.dailyLevelTime = const Value.absent(),
    this.seriesCurrentLevel = const Value.absent(),
    this.seriesAccumulatedTime = const Value.absent(),
    this.isSeriesCompleted = const Value.absent(),
  });
  ...
  static Insertable<DailyChallenge> custom({
    ...
    return RawValuesInsertable({
      ...
      if (isDailyLevelCompleted != null)
        'is_daily_level_completed': isDailyLevelCompleted,
      if (dailyLevelTime != null) 'daily_level_time': dailyLevelTime,
      if (seriesCurrentLevel != null)
        'series_current_level': seriesCurrentLevel,
      if (seriesAccumulatedTime != null)
        'series_accumulated_time': seriesAccumulatedTime,
  ...
  DailyChallengesCompanion copyWith({
    ...
    Value<String>? playerSupabaseId,
    Value<String>? date,
    Value<bool>? isDailyLevelCompleted,
    Value<int>? dailyLevelTime,
    Value<int>? seriesCurrentLevel,
    Value<int>? seriesAccumulatedTime,
    Value<bool>? isSeriesCompleted,
  }) {
    return DailyChallengesCompanion(
      id: id ?? this.id,
      playerSupabaseId: playerSupabaseId ?? this.playerSupabaseId,
      date: date ?? this.date,
      isDailyLevelCompleted:
          isDailyLevelCompleted ?? this.isDailyLevelCompleted,
      dailyLevelTime: dailyLevelTime ?? this.dailyLevelTime,
      seriesCurrentLevel: seriesCurrentLevel ?? this.seriesCurrentLevel,
      seriesAccumulatedTime:
          seriesAccumulatedTime ?? this.seriesAccumulatedTime,
      isSeriesCompleted: isSeriesCompleted ?? this.isSeriesCompleted,
    );
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (isDailyLevelCompleted.present) {
      map['is_daily_level_completed'] = Variable<bool>(
        isDailyLevelCompleted.value,
      );
    }
    ...
    if (seriesAccumulatedTime.present) {
      map['series_accumulated_time'] = Variable<int>(
        seriesAccumulatedTime.value,
      );
    }
...
class $ActiveGameStatesTable extends ActiveGameStates
    with TableInfo<$ActiveGameStatesTable, ActiveGameState> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ActiveGameStatesTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  static const VerificationMeta _currentPathJsonMeta = const VerificationMeta(
    'currentPathJson',
  );
  @override
  late final GeneratedColumn<String> currentPathJson = GeneratedColumn<String>(
    'current_path_json',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'active_game_states';
  @override
  VerificationContext validateIntegrity(
    Insertable<ActiveGameState> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('current_path_json')) {
      context.handle(
        _currentPathJsonMeta,
        currentPathJson.isAcceptableOrUnknown(
          data['current_path_json']!,
          _currentPathJsonMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_currentPathJsonMeta);
    }
    if (data.containsKey('updated_at')) {
      context.handle(
        _updatedAtMeta,
  ...
  @override
  ActiveGameState map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ActiveGameState(
      ...
      currentPathJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}current_path_json'],
      )!,
      updatedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}updated_at'],
  ...
  @override
  $ActiveGameStatesTable createAlias(String alias) {
    return $ActiveGameStatesTable(attachedDatabase, alias);
  }
}

class ActiveGameState extends DataClass implements Insertable<ActiveGameState> {
  final int id;
  final String playerSupabaseId;
  final String worldId;
  final int levelNumber;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['current_path_json'] = Variable<String>(currentPathJson);
    map['updated_at'] = Variable<DateTime>(updatedAt);
    return map;
  }

  ActiveGameStatesCompanion toCompanion(bool nullToAbsent) {
    return ActiveGameStatesCompanion(
      id: Value(id),
      playerSupabaseId: Value(playerSupabaseId),
      worldId: Value(worldId),
      levelNumber: Value(levelNumber),
      ...
      currentPathJson: Value(currentPathJson),
      updatedAt: Value(updatedAt),
    );
  }

  factory ActiveGameState.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ActiveGameState(
      ...
      currentPathJson: serializer.fromJson<String>(json['currentPathJson']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'currentPathJson': serializer.toJson<String>(currentPathJson),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
    };
  }
  ...
  ActiveGameState copyWith({
    ...
    currentPathJson: currentPathJson ?? this.currentPathJson,
    updatedAt: updatedAt ?? this.updatedAt,
  );
  ActiveGameState copyWithCompanion(ActiveGameStatesCompanion data) {
    return ActiveGameState(
      id: data.id.present ? data.id.value : this.id,
      playerSupabaseId: data.playerSupabaseId.present
          ? data.playerSupabaseId.value
      ...
      currentPathJson: data.currentPathJson.present
          ? data.currentPathJson.value
          : this.currentPathJson,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('ActiveGameState(')
          ..write('id: $id, ')
          ..write('playerSupabaseId: $playerSupabaseId, ')
          ..write('worldId: $worldId, ')
          ..write('levelNumber: $levelNumber, ')
          ...
          ..write('currentPathJson: $currentPathJson, ')
          ..write('updatedAt: $updatedAt')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is ActiveGameState &&
          ...
          other.currentPathJson == this.currentPathJson &&
          other.updatedAt == this.updatedAt);
}

class ActiveGameStatesCompanion extends UpdateCompanion<ActiveGameState> {
  final Value<int> id;
  final Value<String> playerSupabaseId;
  final Value<String> worldId;
  final Value<int> levelNumber;
  ...
  final Value<String> currentPathJson;
  final Value<DateTime> updatedAt;
  const ActiveGameStatesCompanion({
    this.id = const Value.absent(),
    this.playerSupabaseId = const Value.absent(),
    this.worldId = const Value.absent(),
    this.levelNumber = const Value.absent(),
    ...
    this.currentPathJson = const Value.absent(),
    this.updatedAt = const Value.absent(),
  });
  ActiveGameStatesCompanion.insert({
    this.id = const Value.absent(),
    required String playerSupabaseId,
    required String worldId,
    required int levelNumber,
    ...
    required String currentPathJson,
    this.updatedAt = const Value.absent(),
  }) : playerSupabaseId = Value(playerSupabaseId),
       worldId = Value(worldId),
       levelNumber = Value(levelNumber),
       ...
       remainingSeconds = Value(remainingSeconds),
       currentPathJson = Value(currentPathJson);
  static Insertable<ActiveGameState> custom({
    Expression<int>? id,
    Expression<String>? playerSupabaseId,
    Expression<String>? worldId,
    Expression<int>? levelNumber,
    ...
    Expression<String>? currentPathJson,
    Expression<DateTime>? updatedAt,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      ...
      if (currentPathJson != null) 'current_path_json': currentPathJson,
      if (updatedAt != null) 'updated_at': updatedAt,
    });
  }

  ActiveGameStatesCompanion copyWith({
    Value<int>? id,
    Value<String>? playerSupabaseId,
    Value<String>? worldId,
    Value<int>? levelNumber,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (currentPathJson.present) {
      map['current_path_json'] = Variable<String>(currentPathJson.value);
    }
    if (updatedAt.present) {
      map['updated_at'] = Variable<DateTime>(updatedAt.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('ActiveGameStatesCompanion(')
          ..write('id: $id, ')
          ..write('playerSupabaseId: $playerSupabaseId, ')
          ..write('worldId: $worldId, ')
          ..write('levelNumber: $levelNumber, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $LevelCompletionsTable levelCompletions = $LevelCompletionsTable(
    this,
  );
  ...
  late final $ActiveGameStatesTable activeGameStates = $ActiveGameStatesTable(
    this,
  );
  @override
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> puzzlePieces = const Value.absent(),
...
class $$ProgressionsTableFilterComposer
    extends Composer<_$AppDatabase, $ProgressionsTable> {
  ...
  get unlockedWorlds => $composableBuilder(
...
class $$ProgressionsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<List<String>, String> get unlockedWorlds =>
      $composableBuilder(
        column: $table.unlockedWorlds,
        builder: (column) => column,
      );
...
class $$ProgressionsTableTableManager
    extends
        RootTableManager<
          ...
          (
            Progression,
            BaseReferences<_$AppDatabase, $ProgressionsTable, Progression>,
          ),
          Progression,
          PrefetchHooks Function()
        > {
  $$ProgressionsTableTableManager(_$AppDatabase db, $ProgressionsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ({
                ...
                Value<List<String>> unlockedWorlds = const Value.absent(),
                Value<DateTime?> updatedAt = const Value.absent(),
...
class $$LevelCompletionsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<int> completionTimeSeconds = const Value.absent(),
...
typedef $$LevelCompletionsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $LevelCompletionsTable,
      LevelCompletion,
      ...
      PrefetchHooks Function()
    >;
typedef $$GlobalLevelsTableCreateCompanionBuilder =
    GlobalLevelsCompanion Function({
      Value<int> id,
      required String worldId,
      required int levelNumber,
      required String hintsJson,
...
typedef $$GlobalLevelsTableUpdateCompanionBuilder =
    GlobalLevelsCompanion Function({
      Value<int> id,
      Value<String> worldId,
      Value<int> levelNumber,
...
class $$GlobalLevelsTableFilterComposer
    extends Composer<_$AppDatabase, $GlobalLevelsTable> {
...
class $$GlobalLevelsTableOrderingComposer
    extends Composer<_$AppDatabase, $GlobalLevelsTable> {
...
class $$GlobalLevelsTableAnnotationComposer
    extends Composer<_$AppDatabase, $GlobalLevelsTable> {
  ...
  GeneratedColumn<String> get hintsJson =>
      $composableBuilder(column: $table.hintsJson, builder: (column) => column);

  GeneratedColumn<String> get wallsJson =>
      $composableBuilder(column: $table.wallsJson, builder: (column) => column);
...
class $$GlobalLevelsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $GlobalLevelsTable,
          ...
          (
            GlobalLevel,
            BaseReferences<_$AppDatabase, $GlobalLevelsTable, GlobalLevel>,
          ),
          GlobalLevel,
          PrefetchHooks Function()
        > {
  $$GlobalLevelsTableTableManager(_$AppDatabase db, $GlobalLevelsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$GlobalLevelsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$GlobalLevelsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$GlobalLevelsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> worldId = const Value.absent(),
                Value<int> levelNumber = const Value.absent(),
                Value<String> hintsJson = const Value.absent(),
                Value<String> wallsJson = const Value.absent(),
                Value<String> solutionJson = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
              }) => GlobalLevelsCompanion(
                id: id,
                worldId: worldId,
                levelNumber: levelNumber,
                hintsJson: hintsJson,
...
typedef $$GlobalLevelsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $GlobalLevelsTable,
      GlobalLevel,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> friendUsername = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
              }) => FriendsCompanion(
                id: id,
                playerId: playerId,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<bool> isDailyLevelCompleted = const Value.absent(),
                Value<int> dailyLevelTime = const Value.absent(),
                Value<int> seriesCurrentLevel = const Value.absent(),
                Value<int> seriesAccumulatedTime = const Value.absent(),
                Value<bool> isSeriesCompleted = const Value.absent(),
              }) => DailyChallengesCompanion(
                id: id,
                playerSupabaseId: playerSupabaseId,
                date: date,
                isDailyLevelCompleted: isDailyLevelCompleted,
                dailyLevelTime: dailyLevelTime,
                seriesCurrentLevel: seriesCurrentLevel,
                seriesAccumulatedTime: seriesAccumulatedTime,
...
typedef $$DailyChallengesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$ActiveGameStatesTableCreateCompanionBuilder =
    ActiveGameStatesCompanion Function({
      Value<int> id,
      required String playerSupabaseId,
      required String worldId,
      required int levelNumber,
...
typedef $$ActiveGameStatesTableUpdateCompanionBuilder =
    ActiveGameStatesCompanion Function({
      Value<int> id,
      Value<String> playerSupabaseId,
      Value<String> worldId,
...
class $$ActiveGameStatesTableFilterComposer
    extends Composer<_$AppDatabase, $ActiveGameStatesTable> {
  $$ActiveGameStatesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get currentPathJson => $composableBuilder(
    column: $table.currentPathJson,
    builder: (column) => ColumnFilters(column),
  );
...
class $$ActiveGameStatesTableOrderingComposer
    extends Composer<_$AppDatabase, $ActiveGameStatesTable> {
  $$ActiveGameStatesTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get currentPathJson => $composableBuilder(
    column: $table.currentPathJson,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$ActiveGameStatesTableAnnotationComposer
    extends Composer<_$AppDatabase, $ActiveGameStatesTable> {
  $$ActiveGameStatesTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get currentPathJson => $composableBuilder(
    column: $table.currentPathJson,
    builder: (column) => column,
  );
...
class $$ActiveGameStatesTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $ActiveGameStatesTable,
          ActiveGameState,
          $$ActiveGameStatesTableFilterComposer,
          $$ActiveGameStatesTableOrderingComposer,
          $$ActiveGameStatesTableAnnotationComposer,
          $$ActiveGameStatesTableCreateCompanionBuilder,
          $$ActiveGameStatesTableUpdateCompanionBuilder,
          (
            ActiveGameState,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$ActiveGameStatesTableTableManager(
    _$AppDatabase db,
    $ActiveGameStatesTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ActiveGameStatesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ActiveGameStatesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ActiveGameStatesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<String> playerSupabaseId = const Value.absent(),
                ...
                Value<String> currentPathJson = const Value.absent(),
                Value<DateTime> updatedAt = const Value.absent(),
              }) => ActiveGameStatesCompanion(
                id: id,
                playerSupabaseId: playerSupabaseId,
                worldId: worldId,
                levelNumber: levelNumber,
...
typedef $$ActiveGameStatesTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $ActiveGameStatesTable,
      ActiveGameState,
      ...
      (
        ActiveGameState,
        BaseReferences<_$AppDatabase, $ActiveGameStatesTable, ActiveGameState>,
      ),
      ActiveGameState,
      PrefetchHooks Function()
    >;
...
class $AppDatabaseManager {
  ...
  $$GlobalLevelsTableTableManager get globalLevels =>
      $$GlobalLevelsTableTableManager(_db, _db.globalLevels);
  ...
  $$ActiveGameStatesTableTableManager get activeGameStates =>
      $$ActiveGameStatesTableTableManager(_db, _db.activeGameStates);
}
